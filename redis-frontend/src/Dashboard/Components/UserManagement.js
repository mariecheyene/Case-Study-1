...
const UserManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Normalize the role to match backend expectations
      const normalizedRole = formData.role === 'barangayOfficial' ? 'barangayOfficial' : formData.role;
      ...
      console.log("Submitting user:", userData); // Debug log
